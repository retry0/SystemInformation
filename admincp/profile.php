        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="alert bg-info">
                  <p class="text-info"><i class="fa fa-info-circle fa-2x pull-left"></i> This is the page to change the profile.</p>
                </div>
                <?php
                  error_reporting(0);
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Profile Successfully Saved</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                ...
                ?>
                <form role="form" class="form-group" action="function/edit-profile.php?user=<?php echo $u['user']; ?>" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                      <div class="box">
                        ...
                        <div class="box-body">
                          ...
                          <input type="text" class="form-control" name="full_name" value="<?php echo $u['full_name']; ?>">
                          <br>
                          ...
                          <br>
                          <label>Address</label>
                          <textarea type="text" class="form-control" name="alamat"><?php echo $u['alamat']; ?></textarea>
                          <br>
                          ...
                          <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <input type="text" class="form-control" name="user" value="<?php echo $u['user']; ?>" disabled>
                              <br>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <label>Password</label>
                              <input type="password" class="form-control" name="pass" value="<?php echo $u['re_pass']; ?>">
                              <br>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="box-body">
                          <table class="table">
                            ...
                            <tr>
                              <td colspan="3">
                                <ol>
                                  <li><strong>Image</strong> : The image format is jpg or png.</li>
