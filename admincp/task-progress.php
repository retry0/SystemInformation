        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <?php
                  ...
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Task Progress Berhasil Disimpan</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                  ...
                  $id = $_GET['id'];
                  $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_task_progress` WHERE task_id = '$id' ORDER BY id DESC") or die(mysqli_error());
                  $s1 = mysqli_fetch_array($sql_1);
                ?>
                <form role="form" action="function/edit-taskprogress.php?id=<?php echo $s1['id']; ?>&task_id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="box">
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="project_task" value="<?php echo $s1['project_task']; ?>">
                            <br>
                          </div>
                          <div class="form-group">
                            <label>Title</label>
                          ...
                          <div class="text-right">
                            <button type="submit" name="submit" class="btn btn-primary">Submit</button>&nbsp;<a href="view-working.php" class="btn btn-default">Cancel</a>
                          </div>
                        </div>
                      </div>                
                    </div><!-- /.col -->
