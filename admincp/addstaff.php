        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="alert bg-info">
                  <p class="text-info"><i class="fa fa-info-circle fa-2x pull-left"></i> This is the page to add Staff data</p>
                </div>
                <?php
                  error_reporting(0);
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Staff Successfully Saved</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                ...
                ?>
                <form role="form" class="form-group" action="function/add-staff.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="box">
                        ...
                        <div class="box-body">
                          ...
                          <select class="form-control" name="full_name">
                            ...
                            <?php 
                              $staff = mysqli_query($conn, "SELECT * FROM `tb_user` ORDER BY full_name ASC");
                        ...
                        <div class="box-body">
                          <table class="table">
                            ...
                            <tr>
                              <td colspan="3">
                                <ol>
                                  <li>Fill in the data data according to your personal data.</li>
                                </ol>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <td colspan="3">
                              <div class="pull-right">
                                <button type="submit" name="submit" class="btn btn-primary">Saved</button>&nbsp;<a href="staff.php" class="btn btn-default">Batal</a>
                              </div>
                            </td>
                            </tr>
                          </table>
