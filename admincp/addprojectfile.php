        ...
        <div class="content-wrapper">
            <section class="content-header">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">Add Project File</li>
              </ol>
              <hr>
            </section>
            <section class="content">
                <div class="alert bg-info">
                  <p class="text-info"><i class="fa fa-info-circle fa-2x pull-left"></i> This is the page for adding Project File.</p>
                </div>
                <?php
                  error_reporting(0);
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Project File Successfully Saved</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                  ...
                  $id = $_GET['id'];
                  $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_project_file` where id ORDER BY id DESC") or die(mysqli_error());
                  $s1 = mysqli_fetch_array($sql_1);
                ?>
                <form role="form" class="form-group" action="function/add-project-file.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                          ...
                          <table class="table">
                            ...
                            <td colspan="3">
                              <div class="pull-right">
                                <button type="submit" name="submit" class="btn btn-primary">Saved</button>&nbsp;<a href="projectfile.php" class="btn btn-default">Canceled</a>
                              </div>
                            </td>
                            </tr>
                          </table>
