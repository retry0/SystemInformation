        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="alert bg-info">
                  <p class="text-info"><i class="fa fa-info-circle fa-2x pull-left"></i>This is the page to add Client.</p>
                </div>
                <?php
                  error_reporting(0);
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Client Successfully Saved</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                ...
                ?>
                <form role="form" class="form-group" action="function/add-client.php" method="post" enctype="multipart/form-data">
                  <div class="row">
