...
<html lang="en">
  ...
  <body class="skin-black">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="alert bg-info">
                  <p class="text-info"><i class="fa fa-info-circle fa-2x pull-left"></i> This is the page for adding Project.</p>
                </div>
                <?php
                  error_reporting(0);
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Project Successfully Saved</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                ...
                ?>
                <form role="form" class="form-group" action="function/add-project.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                              ...
                              <select class="form-control" name="client">
                                ...
                                ?>
                                <option value="<?php echo $s['company']; ?>"><?php echo $s['company']; ?></option>
                                <?php
                                  } 
                                ?>
                              </select>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                              ...
                              <select class="form-control" name="pm">
                                ...
                                ?>
                                    <option value="<?php echo $p['full_name']; ?>"><?php echo $p['full_name']; ?></option>
                                <?php
                                    } 
                                ?>
                              </select>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                              ...
                              <input type="text" class="form-control" name="start_date" id="reservation" required="">
                              <br>
                              <label>End Date</label>
                              <input type="text" class="form-control" name="end_date" id="reservations" required="">
                              <br>
                            </div>
                             <div class="col-md-4 col-sm-4 col-xs-12">
    ...
    <!-- Morris.js charts -->
    <script src="plugins/raphael/raphael-min"></script>
    <!-- Sparkline -->
