        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="alert bg-info">
                  <p class="text-info"><i class="fa fa-info-circle fa-2x pull-left"></i>This is the page to add Asset.</p>
                </div>
                <?php
                  error_reporting(0);
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '<div class="alert bg-success"><p class="text-success">Asset Successfully Saved</p></div>';
                    }
                    if ($_GET['notif'] == 2) {
                ...
                ?>
                <form role="form" class="form-group" action="function/add-asset.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                      <div class="box">
                        ...
                        <div class="box-body">
                          ...
                          <input type="text" class="form-control" name="asset_description">
                          <br>
                          <label>Date of Purchase</label>
                          <input type="text" class="form-control" name="date_of_purchase" id="reservation">
                          <br>
                         ...
                         <label>Status</label>
                          <select class="form-control" name="status">
                            <option value=""> -- Select Status Asset -- </option>
                                ...
                                <option value="In use"> Not Use </option>                                
                                </select>
                          <br>
                           <label>Image</label>
