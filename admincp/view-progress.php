                              ...
                              <table class="table table-bordered table-striped table-hover" id="example1">
                                <thead>
                                  <tr>
                                    ...
                                    <th class="text-center">Description / File Name</th>
                                ...
                                <tbody>
                                  <?php
                                    $id = $_GET['id'];
                                    $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_task_progress` WHERE task_id = '$id' ORDER BY id ASC") or die(mysqli_error());
                                    $no=0;
                                    while($s1 = mysqli_fetch_array($sql_1)){
                                      $no++;
                                      $user = $s1['user'];
                                      $getuser = mysqli_query($conn,"SELECT * FROM `tb_user` WHERE user = '$user'") or die(mysqli_error());
                                      $gu = mysqli_fetch_array($getuser);
                                      $full_name = $gu['full_name'];
                                  ?>
                                  <tr>
                                    <td class="text-center" style="vertical-align: middle;"><?php echo $no; ?></td>
                                    <td class="text-center" style="vertical-align: middle;"><?php echo $full_name; ?></td>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"><?php echo $s1['description']; ?></td>
